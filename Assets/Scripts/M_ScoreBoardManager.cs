...
public class M_ScoreBoardManager : MonoBehaviour {

    // Use this for initialization
    LevelPropertyManagerMulti _levelPropertyManager;
    ...
    void Start () {
        _levelPropertyManager = FindObjectOfType<LevelPropertyManagerMulti>();
